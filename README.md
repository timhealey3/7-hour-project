...
- **Week 3** Conversational Sensors over time https://github.com/timhealey3/conversational-sensor | Record data from a arduino board, have a LLM be able to read data over time and act upon it
